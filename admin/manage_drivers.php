...
if (isset($_POST['approve'])) {
    ...
    $driver_user_id = $conn->query("SELECT user_id FROM drivers WHERE id = $driver_id")->fetch_assoc()['user_id'];
    $adminNotifications->notifyDriverApproved($driver_user_id);
    $message = 'Driver approved successfully and notified by email.';
}
...
if (isset($_POST['reject'])) {
    ...
    $driver_user_id = $conn->query("SELECT user_id FROM drivers WHERE id = $driver_id")->fetch_assoc()['user_id'];
    $adminNotifications->notifyDriverRejected($driver_user_id);
    $message = 'Driver rejected successfully and notified by email.';
}
