...
<body>
            ...
            <tbody>
                <?php while ($student = $assigned_students->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($student['schedule'] ?: 'Not provided'); ?></td>
                ...
                <tbody>
                    <?php while ($trip = $today_trips->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $trip['dropoff_time'] ? $trip['dropoff_time'] : 'Not set'; ?></td>
    ...
    <script>
        function performAction(action, tripId) {
            ...
            btn.textContent = '⏳...';
            submitAction(action, tripId, btn, originalText);
        }
        
        function submitAction(action, tripId, btn, originalText) {
